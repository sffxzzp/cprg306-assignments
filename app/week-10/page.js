				...
				{user ? (
					<div className="space-y-4 text-center">
						...
						<div className="flex flex-col sm:flex-row gap-3 justify-center">
							<Link className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition hover:cursor-pointer" href="/week-10/shopping-list">Go to Shopping List</Link>
